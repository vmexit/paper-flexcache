...
%
To properly classify the data, we collect the hotness distribution of data in the phase as hotness information.
%
Without lose of generality, only a part of data can be kept in the cache, so we can choose a portion of data to be cached based on the hotness counter.
%
Then, we sort data by the hotness counter in descending order, and progressively fill the portion.
%
the hotness counter at which reaches the portion is treated as the hotness threshold to separate frequent and infrequent types.
%
