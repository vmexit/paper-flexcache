...
If the cache size is relatively large, there are too many objects accessed many times, so we need to improve the criteria to filter out the important objects. \dots
%

If the cache size is relatively small, some data may not be accessed until several phases later. We need to speculatively retain these data. \dots
