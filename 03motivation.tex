...
%
To reduce the space overhead of recording all accesses in the sliding window, a FIFO queue with a frequency counter has a similar effect to the sliding window.
%
