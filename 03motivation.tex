...
%
The more hits within a phase, the more suitable the access pattern is for caching, and it also indicates that the cache is relatively large with a higher hit rate.
%
...
We analyze \XXX{} workloads and decide to cache part of the objects.
%
