...
%
\sys decides to discard the repeated access objects or hold part of objects based on the overall cache access behavior (e.g., improve the threshold to two or three).
