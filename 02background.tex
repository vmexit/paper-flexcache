...
\PN{Static Cache Eviction Algorithms.}

\PN{Adaptive Cache Eviction Algorithms.}
...
\subsubsection{Static cache eviction algorithms.}

\subsubsection{Adaptive cache eviction algorithms.}
%
Adaptive cache eviction algorithms promise to efficiently handle modern 
workloads by adjusting their behavior based on observed access patterns.
%
However, existing adaptive cache eviction algorithms fall short of this 
...
\PN{Limitation \#1: Cannot handle important access patterns.}
