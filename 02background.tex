...
Generally, cache systems have three main research directions: access pattern analysis, cache replacement policies, and cache prefetching. 
%
...
This classification method cannot tell us the object type, only the trace type.
%
