...
%
The one-side transition framework explores only a part of linear interpolation between \textit{LRU-friendly} and \textit{LFU-friendly} patterns.
...
%
Moreover, under such a framework, policy A may evict the data that policy B focuses on, and the confliction breaks the originally intended linear interpolation space.