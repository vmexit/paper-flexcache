...
Our analysis reveals two main reasons for the poor performance of existing adaptive algorithms. 
%
First, their design inherently 

\XXX{Need to better summary here?}

\XXX{Consider a table to make the argument.}
\PN{Limited access pattern coverage.}
%
\XXX{Adpativeness: failing to cover acccess patterns.}
...
\PN{Poor multicore performanace.}
%
