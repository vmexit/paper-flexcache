...
%
We evaluate the hit ratio of replacement policies under a given cache size, which is a relative size to working set size(WSS). 
%
...
%
What's more, the performance of WTinyLFU~\cite{} is metastable at all cache sizes.
%
...
%
As shown is figure~\ref{fig:mrcdemo}(b) and figure~\ref{fig:alibb}(a), the performance of ARC, WTinyLFU, and LeCaR degrade when the cache size is larger.
%
