call "data/common.gnuplot" "7.5in, 1.2in"
set output "`echo $OUT`"
...
plot "data/hitimp/withoutobjsize/0.01.dat" using 2:0 with points ls 1 pt 9 ps 2 title '\sys', \
    ...
    "data/hitimp/withoutobjsize/0.01.dat" using 4:0 with points ls 3 title '', \
    "data/hitimp/withoutobjsize/0.01.dat" using 5:0 with points ls 7 title '', \
    "data/hitimp/withoutobjsize/0.01.dat" using 6:0 with points ls 8 title '', \
    "data/hitimp/withoutobjsize/0.01.dat" using 7:0 with points ls 9 title '', \
    "data/hitimp/withoutobjsize/0.01.dat" using 8:0 with points ls 10 title '', \
...
plot "data/hitimp/withoutobjsize/0.03.dat" using 2:0 with points ls 1 pt 9 ps 2 title '', \
    ...
    "data/hitimp/withoutobjsize/0.03.dat" using 4:0 with points ls 3 title 'ARC', \
    "data/hitimp/withoutobjsize/0.03.dat" using 5:0 with points ls 7 title 'Cacheus', \
    "data/hitimp/withoutobjsize/0.03.dat" using 6:0 with points ls 8 title 'LeCaR', \
    "data/hitimp/withoutobjsize/0.03.dat" using 7:0 with points ls 9 title '', \
    "data/hitimp/withoutobjsize/0.03.dat" using 8:0 with points ls 10 title '', \
...
plot "data/hitimp/withoutobjsize/0.1.dat" using 2:0 with points ls 1 pt 9 ps 2 title '', \
    ...
    "data/hitimp/withoutobjsize/0.1.dat" using 5:0 with points ls 7 title '', \
    "data/hitimp/withoutobjsize/0.1.dat" using 6:0 with points ls 8 title '', \
    "data/hitimp/withoutobjsize/0.1.dat" using 7:0 with points ls 9 title 'LIRS', \
    "data/hitimp/withoutobjsize/0.1.dat" using 8:0 with points ls 10 title 'WTinyLFU', \
