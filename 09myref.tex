\section{myref}
replacement policy:
S3FIFO~\cite{yang2023fifo}, LHD~\cite{beckmann2018lhd}, TinyLFU~\cite{einziger2017tinylfu},CACHEUS~\cite{rodriguez2021learning}
...
To our knowledge, HAC~\cite{Miguel1997HAC} is the first adaptive caching system.


cache in dm
ditto~\cite{shen2023ditto},SWARM~\cite{Murat2024SWARM}
