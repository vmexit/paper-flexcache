...
MQ~\cite{zhou2001multi},ARC~\cite{megiddo2003arc},CAR~\cite{bansal2004car},LIRS~\cite{jiang2002lirs}

Baleen~\cite{wong2024baleen}(CXL prefetch)
MITHRIL~\cite{yang2017mithril}

cliff removing Talus~\cite{beckmann2015talus},Cliffhanger~\cite{cidon2016cliffhanger},SHARDS~\cite{waldspurger2015efficient}