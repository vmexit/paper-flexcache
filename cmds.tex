...
\newcommand{\SK}[1]{\noindent{\color{orange} {\bf \fbox{SK:}} #1}}
\newcommand{\VG}[1]{\noindent{\color{violet} {\bf \fbox{VG:}} #1}}
\newcommand{\KK}[1]{\noindent{\color{green} {\bf \fbox{KK:}} #1}}
\newcommand{\YK}[1]{\noindent{\color{blue} {\bf \fbox{YK:}} #1}}
\newcommand{\DZ}[1]{\noindent{\color{brown} {\bf \fbox{DZ:}} #1}}
\newcommand{\PJ}[1]{\noindent{\color{purple} {\bf \fbox{PJ:}} #1}}
