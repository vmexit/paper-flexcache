...
\newcommand{\TODO}[1]{\noindent{\color{red} {\bf \fbox{TODO:}} #1}}
\newcommand{\ABB}[1]{$\mathcal{#1}$}
\newcommand{\FY}[1]{\noindent{\color{blue} {\bf \fbox{FY:}} #1}}

\newcommand{\lru}{\mbox{\cc{LRU}}\xspace}
\newcommand{\lfu}{\mbox{\cc{LFU}}\xspace}
\newcommand{\fifo}{\mbox{\cc{FIFO}}\xspace}
\newcommand{\lirs}{\mbox{\cc{LIRS}}\xspace}
\newcommand{\lhdc}{\mbox{\cc{LHD}}\xspace}
\newcommand{\wtinylfu}{\mbox{\cc{W-TinyLFU}}\xspace}
\newcommand{\twoqueue}{\mbox{\cc{2Q}}\xspace}
\newcommand{\cacheus}{\mbox{\cc{Cacheus}}\xspace}
\newcommand{\cacheuss}{\mbox{\cc{Cacheus'}}\xspace}
\newcommand{\sieve}{\mbox{\cc{SIEVE}}\xspace}
\newcommand{\lecar}{\mbox{\cc{LeCaR}}\xspace}
\newcommand{\arc}{\mbox{\cc{ARC}}\xspace}
\newcommand{\car}{\mbox{\cc{CAR}}\xspace}
\newcommand{\sthreefifo}{\mbox{\cc{S3-FIFO}}\xspace}


\newcommand{\cachelib}{\mbox{\cc{CacheLib}}\xspace}
\newcommand{\libcachesim}{\mbox{\cc{libCacheSim}}\xspace}


\newcommand{\hotness}{hotness\xspace}
\newcommand{\hot}{hot\xspace}
\newcommand{\cold}{cold\xspace}
\newcommand{\popularity}{popularity\xspace}
\newcommand{\popular}{popular\xspace}
\newcommand{\rare}{rare\xspace}

\newcommand{\filter}{filter\xspace}
\newcommand{\core}{core\xspace}
\newcommand{\staging}{staging\xspace}
\newcommand{\sketch}{sketch\xspace}
\newcommand{\ghost}{ghost\xspace}
\newcommand{\auxiliary}{auxiliary\xspace}

\newcommand{\hitrate}{hit rate\xspace}
\newcommand{\missrate}{miss rate\xspace}
